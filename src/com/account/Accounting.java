...
public class Accounting {
	...
	private bo.file.Menus boMenus;
	private bo.file.UserAccess boUserAccess;
	public Accounting() throws DAException
	{
		...
		boMenus=new bo.file.Menus();
		boUserAccess=new bo.file.UserAccess();
	}
	...
	{
		sf.accounting.User user = new sf.accounting.User();
		user.setUsers(boUser.getSales(company));
		return user;
	}
