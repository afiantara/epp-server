...
public class HargaJual extends General {
	/**
	 * 
	 */
	...
	public void setHargaJuals(HargaJual[] hargaJuals) {
		this.hargaJuals = hargaJuals;
	}

	public HargaJual[] getHargaJuals() {
		return hargaJuals;
	}
