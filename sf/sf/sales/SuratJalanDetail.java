...
public class SuratJalanDetail extends General{
	...
	private  SuratJalanDetail[] sjDetails;
	
	public SuratJalanDetail()
	{
	...
	public void setSjDetails(SuratJalanDetail[] sjDetails) {
		this.sjDetails = sjDetails;
	}

	public SuratJalanDetail[] getSjDetails() {
		return sjDetails;
	}
