...
public class HargaJual {
	...
	public sf.inventory.HargaJual[] getHargaJual() throws DAException
	{
		...
		try
		{
			String strSQL="SELECT a.*,b.nbarang,b.satuan FROM mhjual a, mproduk b where a.recstatus<>? and a.kbarang=b.kbarang";
	...
	public sf.inventory.HargaJual getLatestHargaJualByValuta(String kbarang,String kvaluta,String tglBukti) throws DAException
	{
		try
		{
			String strSQL="SELECT a.*,b.nbarang,b.satuan FROM mhjual a,mproduk b where a.recstatus<>? and a.kbarang=? and a.ktanggal <=? and a.kvaluta=? and a.kbarang=b.kbarang order by a.ktanggal desc LIMIT 0,1";
	...
	public sf.inventory.HargaJual getLatestHargaJual(String kbarang,String tglBukti) throws DAException
	{
		try
		{
			String strSQL="SELECT a.*,b.nbarang,b.satuan FROM mhjual a,mproduk b where a.recstatus<>? and a.kbarang=b.kbarang and a.kbarang=? and a.ktanggal <=? order by a.ktanggal desc LIMIT 0,1";
	...
	public sf.inventory.HargaJual[] getHargaJual(String kbarang) throws DAException
	{
		...
		try
		{
			String strSQL="SELECT a.*,b.nbarang,b.satuan FROM mhjual a,mproduk b where a.recstatus<>? and a.kbarang=? and a.kbarang=b.kbarang";
			PreparedStatement p=db.getStatement(strSQL);
			p.setString(1, "D");
			p.setString(2, kbarang);
			Vector rows = db.getData(p);
